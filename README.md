...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p cef8dd98-a7e0-4786-abf0-d6a69a7a985a
```

> `cef8dd98-a7e0-4786-abf0-d6a69a7a985a` is the password of the certificate, you can change it to any password you want.
