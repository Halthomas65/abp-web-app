...
public class MongoDbAbpSolution1DbSchemaMigrator : IAbpSolution1DbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAbpSolution1DbSchemaMigrator(IServiceProvider serviceProvider)
    {
